...
function Theme({ toggle, settoggle }) {
  return (
    <div className="theme">
      <input
        type="checkbox"
        className="checkbox toggle-switch-checkbox "
        name="toggleSwitch"
        id="toggleSwitch"
        onClick={() => {
          console.log(toggle);
      ...
      />
      <label className="toggle-switch-label" for="toggleSwitch"></label>
    </div>
  );
}
  ...
  return (
    <div className="MainPosition3" id="main_contact">
      ...
      <div className="divsp">
        <div>
          <div>
            <abbr title="+972568191595">
              {" "}
              <a href="tel:+972568191595" target="_blank">
                <img className="contact_icon" src={mobile} />
              </a>
            </abbr>{" "}
            <br></br>
            +972568191595
          ...
          <div>
            <br></br>
            <div>
              <abbr title="sargharam@gmail.com">
                {" "}
                <a href="mailto:sargharam@gmail.com" target="_blank">
                  <img className="contact_icon" src={email} />
                </a>
              </abbr>{" "}
              <br></br>
              sargharam@gmail.com
        ...
        <div>
          <div>
            <abbr title="Gharam Sarsour#2158">
              {" "}
              <a
                href="https://discordapp.com/users/Gharam Sarsour#2158"
                target="_blank"
              >
                <img className="contact_icon" src={discord} />
              </a>
            </abbr>{" "}
            <br></br>
            Gharam Sarsour#2158
          ...
          <div>
            <br></br>
            <div>
              <abbr title="Gharam Sarsour">
                {" "}
                <a
                  href="https://www.linkedin.com/in/gharam-sarsour-b40b5222a/"
                  target="_blank"
                >
                  <img className="contact_icon" src={linkedin} />
                </a>
              </abbr>{" "}
              <br></br>
              Gharam Sarsour
    ...
    <div className="MainPosition" id="main_info">
      ...
      <div className="divsp">
        <div id="info_lines">
          {" "}
          My name is{" "}
          <strong className={toggle ? "whiteText" : "grayText"}>
            {" "}
            &nbsp;Gharam Sarsour{" "}
          </strong>
          , Im 22 years old, I'm a frontend developer,<br></br> currently
          training at foothill technology solution, I have worked<br></br> on
          differant types of projects, I included the most important ones in{" "}
          <br></br> my projects section of this Portfolio.
        </div>
      </div>
    </div>
  );
    ...
    <div className="MainPosition2" id="main_projects">
      <div className="divsp">
        <div>
          <div>
            <a
              href="https://github.com/Gharam-Sar/Orchid-Web-Project.git"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img className="project_icon" src={gitImage} />{" "}
            </a>
            <br></br>

            <name
              className={toggle ? "projectNameWhite" : "projectNameGray"}
              id="project_name"
            >
              Orchid Store
            </name>
            ...
            <description>
              {" "}
              An online plant and Flower Shop, created using html,css,java
              script and php{" "}
            </description>
          </div>
          <br></br>
          ...
          <div>
            {" "}
            <a
              href="https://github.com/Gharam-Sar/Acute-Graduation-Project.git"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img className="project_icon" src={gitImage} />{" "}
            ...
            <description>
              {" "}
              A mobile application to organize eating habits and water drinking,{" "}
              <br></br>
              created with Flutter and runs on a node js server, along with a
              html and css Admin page.
            </description>
          </div>
        </div>
      </div>
    ...
    <div className="MainPosition" id="main_home">
      <div className="divsp">
        <div>
          <p className="intro">
            HI,I'm{" "}
            <span className={toggle ? "whiteText" : "grayText"} id="myname">
              <strong>Gharam Sarsour &nbsp;</strong>
            </span>
            <br></br>
            <span className="intro2">
              &emsp;&emsp;&emsp;&emsp;&emsp; and this is{" "}
              <span className={toggle ? "whiteText" : "grayText"} id="myname2">
